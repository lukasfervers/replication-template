...
With such templates, one can replicate the results from one particular project. The git functions enable more elaborate version control. Among others, changes can be commented with commits. It can be hard in larger projects though
